...
QT_MOC_LITERAL(1, 17, 14), // "exitFullScreen"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 26) // "on_exit_fullscreen_clicked"

    },
    "FullScreenWindow\0exitFullScreen\0\0"
    "on_exit_fullscreen_clicked"
};
...
void FullScreenWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_exit_fullscreen_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FullScreenWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FullScreenWindow::exitFullScreen)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FullScreenWindow::exitFullScreen()
{
